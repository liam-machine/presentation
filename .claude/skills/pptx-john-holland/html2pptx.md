# HTML to PowerPoint Guide - John Holland Edition

Convert HTML slides to PowerPoint presentations with accurate positioning using the `html2pptx.js` library. This guide is configured for John Holland presentations with the official brand color palette.

## John Holland Brand Colors

**ALWAYS use these colors for John Holland presentations:**

### Main Colors
- **Red**: `#EB1E32` - RGB(235, 30, 50) - Primary brand color
- **Purple**: `#55328C` - RGB(85, 50, 140) - Secondary color
- **Light Green**: `#B4D2C3` - RGB(180, 210, 195) - Soft accent

### Additional Colors
- **Light Blue**: `#89D0DD` - RGB(137, 208, 221) - Data visualization
- **Grey**: `#6E6E6E` - RGB(110, 110, 110) - Text and neutral elements
- **Coral Red**: `#EF4B5B` - RGB(239, 75, 91) - Bright accent

### Brand Assets
John Holland logos and partner logos are available in the `assets/` folder for use in presentations.
